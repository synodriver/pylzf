...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "pylzf.backends.cython._lzf_cy",
        "sources": [
            "pylzf/backends/cython/_lzf_cy.pyx",
            "./liblzf/lzf_c.c",
            "./liblzf/lzf_d.c"
        ]
    },
    "module_name": "pylzf.backends.cython._lzf_cy"
}
END: Cython Metadata */
...
#define __PYX_HAVE__pylzf__backends__cython___lzf_cy
#define __PYX_HAVE_API__pylzf__backends__cython___lzf_cy
/* Early includes */
#include <string.h>
#include <stdio.h>
#include <stdint.h>
...
struct __pyx_opt_args_5pylzf_8backends_6cython_7_lzf_cy_compress;

/* "pylzf/backends/cython/_lzf_cy.pyx":10
 * 
 * 
...
/* Module declarations from 'pylzf.backends.cython.lzf' */

/* Module declarations from 'pylzf.backends.cython._lzf_cy' */
...
static CYTHON_INLINE PyObject *__pyx_f_5pylzf_8backends_6cython_7_lzf_cy_compress(__Pyx_memviewslice, int __pyx_skip_dispatch, struct __pyx_opt_args_5pylzf_8backends_6cython_7_lzf_cy_compress *__pyx_optional_args); /*proto*/
static CYTHON_INLINE PyObject *__pyx_f_5pylzf_8backends_6cython_7_lzf_cy_decompress(__Pyx_memviewslice, unsigned int, int __pyx_skip_dispatch); /*proto*/
static CYTHON_INLINE unsigned int __pyx_f_5pylzf_8backends_6cython_7_lzf_cy_compress_into(__Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static CYTHON_INLINE unsigned int __pyx_f_5pylzf_8backends_6cython_7_lzf_cy_decompress_into(__Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "pylzf.backends.cython._lzf_cy"
extern int __pyx_module_is_main_pylzf__backends__cython___lzf_cy;
int __pyx_module_is_main_pylzf__backends__cython___lzf_cy = 0;

/* Implementation of 'pylzf.backends.cython._lzf_cy' */
...
static const char __pyx_k_LZF_VERSION[] = "LZF_VERSION";
...
static PyObject *__pyx_n_s_LZF_VERSION;
...
static PyObject *__pyx_pf_5pylzf_8backends_6cython_7_lzf_cy_compress(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, Py_ssize_t __pyx_v_output_size); /* proto */
static PyObject *__pyx_pf_5pylzf_8backends_6cython_7_lzf_cy_2decompress(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, unsigned int __pyx_v_outlen); /* proto */
static PyObject *__pyx_pf_5pylzf_8backends_6cython_7_lzf_cy_4compress_into(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_out); /* proto */
static PyObject *__pyx_pf_5pylzf_8backends_6cython_7_lzf_cy_6decompress_into(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_out); /* proto */
...
static PyObject *__pyx_pw_5pylzf_8backends_6cython_7_lzf_cy_1compress(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static CYTHON_INLINE PyObject *__pyx_f_5pylzf_8backends_6cython_7_lzf_cy_compress(__Pyx_memviewslice __pyx_v_data, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_5pylzf_8backends_6cython_7_lzf_cy_compress *__pyx_optional_args) {
  Py_ssize_t __pyx_v_output_size = ((Py_ssize_t)0);
  ...
  if (__pyx_optional_args) {
    if (__pyx_optional_args->__pyx_n > 0) {
      __pyx_v_output_size = __pyx_optional_args->output_size;
    }
  }

  /* "pylzf/backends/cython/_lzf_cy.pyx":11
 * 
 * cpdef inline bytes compress(const uint8_t[::1] data, Py_ssize_t output_size = 0):
 *     cdef Py_ssize_t input_size = data.shape[0]             # <<<<<<<<<<<<<<
 *     if output_size == 0:
 ...
 */
  ...
  /* "pylzf/backends/cython/_lzf_cy.pyx":12
 * cpdef inline bytes compress(const uint8_t[::1] data, Py_ssize_t output_size = 0):
 *     cdef Py_ssize_t input_size = data.shape[0]
 *     if output_size == 0:             # <<<<<<<<<<<<<<
 *         output_size = ((input_size * 33) >> 5 ) + 1
 ...
 */
  __pyx_t_1 = ((__pyx_v_output_size == 0) != 0);
  if (__pyx_t_1) {

    /* "pylzf/backends/cython/_lzf_cy.pyx":13
 *     cdef Py_ssize_t input_size = data.shape[0]
 *     if output_size == 0:
 *         output_size = ((input_size * 33) >> 5 ) + 1             # <<<<<<<<<<<<<<
 *     cdef bytes out = PyBytes_FromStringAndSize(NULL, output_size)
 *     if <void*>out == NULL:
 */
    __pyx_v_output_size = (((__pyx_v_input_size * 33) >> 5) + 1);
 ...
 */
  ...
  /* "pylzf/backends/cython/_lzf_cy.pyx":14
 *     if output_size == 0:
 *         output_size = ((input_size * 33) >> 5 ) + 1
 *     cdef bytes out = PyBytes_FromStringAndSize(NULL, output_size)             # <<<<<<<<<<<<<<
 *     if <void*>out == NULL:
 *         raise MemoryError
 */
  __pyx_t_2 = PyBytes_FromStringAndSize(NULL, __pyx_v_output_size); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_v_out = ((PyObject*)__pyx_t_2);
  __pyx_t_2 = 0;

  /* "pylzf/backends/cython/_lzf_cy.pyx":15
 *         output_size = ((input_size * 33) >> 5 ) + 1
 *     cdef bytes out = PyBytes_FromStringAndSize(NULL, output_size)
 *     if <void*>out == NULL:             # <<<<<<<<<<<<<<
 *         raise MemoryError
 ...
 */
  __pyx_t_1 = ((((void *)__pyx_v_out) == NULL) != 0);
  if (unlikely(__pyx_t_1)) {

    /* "pylzf/backends/cython/_lzf_cy.pyx":16
 *     cdef bytes out = PyBytes_FromStringAndSize(NULL, output_size)
 *     if <void*>out == NULL:
 *         raise MemoryError             # <<<<<<<<<<<<<<
 *     cdef unsigned int ret
 ...
 */
  ...
  /* "pylzf/backends/cython/_lzf_cy.pyx":18
 *         raise MemoryError
 *     cdef unsigned int ret
 *     cdef void* out_ptr = <void*> PyBytes_AS_STRING(out)             # <<<<<<<<<<<<<<
 *     with nogil:
 ...
 */
  __pyx_v_out_ptr = ((void *)PyBytes_AS_STRING(__pyx_v_out));

  /* "pylzf/backends/cython/_lzf_cy.pyx":19
 *     cdef unsigned int ret
 *     cdef void* out_ptr = <void*> PyBytes_AS_STRING(out)
 *     with nogil:             # <<<<<<<<<<<<<<
 *         ret = lzf_compress(<void*>&data[0],<unsigned int> input_size, out_ptr, <unsigned int> output_size)
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        /* "pylzf/backends/cython/_lzf_cy.pyx":20
 *     cdef void* out_ptr = <void*> PyBytes_AS_STRING(out)
 *     with nogil:
 *         ret = lzf_compress(<void*>&data[0],<unsigned int> input_size, out_ptr, <unsigned int> output_size)             # <<<<<<<<<<<<<<
 *     if ret == 0:
 ...
 */
        __pyx_t_3 = 0;
        __pyx_v_ret = lzf_compress(((void *)(&(*((uint8_t const  *) ( /* dim=0 */ ((char *) (((uint8_t const  *) __pyx_v_data.data) + __pyx_t_3)) ))))), ((unsigned int)__pyx_v_input_size), __pyx_v_out_ptr, ((unsigned int)__pyx_v_output_size));
      }
 ...
 */
  ...
  /* "pylzf/backends/cython/_lzf_cy.pyx":21
 *     with nogil:
 *         ret = lzf_compress(<void*>&data[0],<unsigned int> input_size, out_ptr, <unsigned int> output_size)
 *     if ret == 0:             # <<<<<<<<<<<<<<
 *         raise ValueError
 ...
 */
  ...
  if (unlikely(__pyx_t_1)) {
    ...
    /* "pylzf/backends/cython/_lzf_cy.pyx":22
 *         ret = lzf_compress(<void*>&data[0],<unsigned int> input_size, out_ptr, <unsigned int> output_size)
 *     if ret == 0:
 *         raise ValueError             # <<<<<<<<<<<<<<
 *     return out[:ret]
 ...
 */
  ...
  /* "pylzf/backends/cython/_lzf_cy.pyx":23
 *     if ret == 0:
 *         raise ValueError
 *     return out[:ret]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_2 = PySequence_GetSlice(__pyx_v_out, 0, __pyx_v_ret); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 */
  ...
  __Pyx_AddTraceback("pylzf.backends.cython._lzf_cy.compress", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_5pylzf_8backends_6cython_7_lzf_cy_1compress(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_5pylzf_8backends_6cython_7_lzf_cy_compress[] = "compress(const uint8_t[::1] data, Py_ssize_t output_size=0) -> bytes";
static PyObject *__pyx_pw_5pylzf_8backends_6cython_7_lzf_cy_1compress(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_data,&__pyx_n_s_output_size,0};
    ...
    __pyx_v_data = __Pyx_PyObject_to_MemoryviewSlice_dc_nn_uint8_t__const__(values[0], 0); if (unlikely(!__pyx_v_data.memview)) __PYX_ERR(0, 10, __pyx_L3_error)
    if (values[1]) {
      __pyx_v_output_size = __Pyx_PyIndex_AsSsize_t(values[1]); if (unlikely((__pyx_v_output_size == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 10, __pyx_L3_error)
    } else {
      __pyx_v_output_size = ((Py_ssize_t)0);
    }
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("compress", 0, 1, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 10, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("pylzf.backends.cython._lzf_cy.compress", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_5pylzf_8backends_6cython_7_lzf_cy_compress(__pyx_self, __pyx_v_data, __pyx_v_output_size);
...
static PyObject *__pyx_pf_5pylzf_8backends_6cython_7_lzf_cy_compress(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, Py_ssize_t __pyx_v_output_size) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  struct __pyx_opt_args_5pylzf_8backends_6cython_7_lzf_cy_compress __pyx_t_2;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("compress", 0);
  ...
  __pyx_t_2.__pyx_n = 1;
  __pyx_t_2.output_size = __pyx_v_output_size;
  __pyx_t_1 = __pyx_f_5pylzf_8backends_6cython_7_lzf_cy_compress(__pyx_v_data, 0, &__pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 10, __pyx_L1_error)
...
/* "pylzf/backends/cython/_lzf_cy.pyx":25
 *     return out[:ret]
 * 
 * cpdef inline bytes decompress(const uint8_t[::1] data, unsigned int outlen):             # <<<<<<<<<<<<<<
 *     cdef Py_ssize_t input_size = data.shape[0]
...
static PyObject *__pyx_pw_5pylzf_8backends_6cython_7_lzf_cy_3decompress(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static CYTHON_INLINE PyObject *__pyx_f_5pylzf_8backends_6cython_7_lzf_cy_decompress(__Pyx_memviewslice __pyx_v_data, unsigned int __pyx_v_outlen, CYTHON_UNUSED int __pyx_skip_dispatch) {
  Py_ssize_t __pyx_v_input_size;
  PyObject *__pyx_v_out = 0;
  unsigned int __pyx_v_ret;
  void *__pyx_v_out_ptr;
  ...
  /* "pylzf/backends/cython/_lzf_cy.pyx":26
 * 
 * cpdef inline bytes decompress(const uint8_t[::1] data, unsigned int outlen):
 *     cdef Py_ssize_t input_size = data.shape[0]             # <<<<<<<<<<<<<<
 *     cdef bytes out = PyBytes_FromStringAndSize(NULL, outlen)
 ...
 */
  ...
  /* "pylzf/backends/cython/_lzf_cy.pyx":27
 * cpdef inline bytes decompress(const uint8_t[::1] data, unsigned int outlen):
 *     cdef Py_ssize_t input_size = data.shape[0]
 *     cdef bytes out = PyBytes_FromStringAndSize(NULL, outlen)             # <<<<<<<<<<<<<<
 *     if <void*>out == NULL:
 *         raise MemoryError
 */
  __pyx_t_1 = PyBytes_FromStringAndSize(NULL, __pyx_v_outlen); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_out = ((PyObject*)__pyx_t_1);
  __pyx_t_1 = 0;

  /* "pylzf/backends/cython/_lzf_cy.pyx":28
 *     cdef Py_ssize_t input_size = data.shape[0]
 *     cdef bytes out = PyBytes_FromStringAndSize(NULL, outlen)
 *     if <void*>out == NULL:             # <<<<<<<<<<<<<<
 *         raise MemoryError
 ...
 */
  ...
  if (unlikely(__pyx_t_2)) {
    ...
    /* "pylzf/backends/cython/_lzf_cy.pyx":29
 *     cdef bytes out = PyBytes_FromStringAndSize(NULL, outlen)
 *     if <void*>out == NULL:
 *         raise MemoryError             # <<<<<<<<<<<<<<
 *     cdef unsigned int ret
 ...
 */
  ...
  /* "pylzf/backends/cython/_lzf_cy.pyx":31
 *         raise MemoryError
 *     cdef unsigned int ret
 *     cdef void* out_ptr = <void*> PyBytes_AS_STRING(out)             # <<<<<<<<<<<<<<
 *     with nogil:
 ...
 */
  ...
  /* "pylzf/backends/cython/_lzf_cy.pyx":32
 *     cdef unsigned int ret
 *     cdef void* out_ptr = <void*> PyBytes_AS_STRING(out)
 *     with nogil:             # <<<<<<<<<<<<<<
 *         ret = lzf_decompress(<void*>&data[0],<unsigned int> input_size, out_ptr, outlen)
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        /* "pylzf/backends/cython/_lzf_cy.pyx":33
 *     cdef void* out_ptr = <void*> PyBytes_AS_STRING(out)
 *     with nogil:
 *         ret = lzf_decompress(<void*>&data[0],<unsigned int> input_size, out_ptr, outlen)             # <<<<<<<<<<<<<<
 *     if ret == 0:
 ...
 */
        __pyx_t_3 = 0;
        __pyx_v_ret = lzf_decompress(((void *)(&(*((uint8_t const  *) ( /* dim=0 */ ((char *) (((uint8_t const  *) __pyx_v_data.data) + __pyx_t_3)) ))))), ((unsigned int)__pyx_v_input_size), __pyx_v_out_ptr, __pyx_v_outlen);
      }
 ...
 */
  ...
  /* "pylzf/backends/cython/_lzf_cy.pyx":34
 *     with nogil:
 *         ret = lzf_decompress(<void*>&data[0],<unsigned int> input_size, out_ptr, outlen)
 *     if ret == 0:             # <<<<<<<<<<<<<<
 *         raise ValueError
 ...
 */
  ...
  if (unlikely(__pyx_t_2)) {
    ...
    /* "pylzf/backends/cython/_lzf_cy.pyx":35
 *         ret = lzf_decompress(<void*>&data[0],<unsigned int> input_size, out_ptr, outlen)
 *     if ret == 0:
 *         raise ValueError             # <<<<<<<<<<<<<<
 *     return out[:ret]
 ...
 */
  ...
  /* "pylzf/backends/cython/_lzf_cy.pyx":36
 *     if ret == 0:
 *         raise ValueError
 *     return out[:ret]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_1 = PySequence_GetSlice(__pyx_v_out, 0, __pyx_v_ret); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 36, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("pylzf.backends.cython._lzf_cy.decompress", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_out);
  __Pyx_XGIVEREF(__pyx_r);
...
/* Python wrapper */
static PyObject *__pyx_pw_5pylzf_8backends_6cython_7_lzf_cy_3decompress(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_5pylzf_8backends_6cython_7_lzf_cy_2decompress[] = "decompress(const uint8_t[::1] data, unsigned int outlen) -> bytes";
static PyObject *__pyx_pw_5pylzf_8backends_6cython_7_lzf_cy_3decompress(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_data = { 0, 0, { 0 }, { 0 }, { 0 } };
  unsigned int __pyx_v_outlen;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_data,&__pyx_n_s_outlen,0};
    PyObject* values[2] = {0,0};
    if (unlikely(__pyx_kwds)) {
      Py_ssize_t kw_args;
      const Py_ssize_t pos_args = PyTuple_GET_SIZE(__pyx_args);
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "decompress") < 0)) __PYX_ERR(0, 25, __pyx_L3_error)
      }
    ...
    __pyx_v_outlen = __Pyx_PyInt_As_unsigned_int(values[1]); if (unlikely((__pyx_v_outlen == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 25, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("decompress", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 25, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("pylzf.backends.cython._lzf_cy.decompress", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_5pylzf_8backends_6cython_7_lzf_cy_2decompress(__pyx_self, __pyx_v_data, __pyx_v_outlen);
...
static PyObject *__pyx_pf_5pylzf_8backends_6cython_7_lzf_cy_2decompress(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, unsigned int __pyx_v_outlen) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __pyx_t_1 = __pyx_f_5pylzf_8backends_6cython_7_lzf_cy_decompress(__pyx_v_data, __pyx_v_outlen, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "pylzf/backends/cython/_lzf_cy.pyx":38
 *     return out[:ret]
 * 
 * cpdef inline unsigned int compress_into(const uint8_t[::1] data, uint8_t[::1] out) except 0:             # <<<<<<<<<<<<<<
 *     cdef unsigned int ret
...
static PyObject *__pyx_pw_5pylzf_8backends_6cython_7_lzf_cy_5compress_into(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static CYTHON_INLINE unsigned int __pyx_f_5pylzf_8backends_6cython_7_lzf_cy_compress_into(__Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_out, CYTHON_UNUSED int __pyx_skip_dispatch) {
  unsigned int __pyx_v_ret;
  ...
  /* "pylzf/backends/cython/_lzf_cy.pyx":40
 * cpdef inline unsigned int compress_into(const uint8_t[::1] data, uint8_t[::1] out) except 0:
 *     cdef unsigned int ret
 *     with nogil:             # <<<<<<<<<<<<<<
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        /* "pylzf/backends/cython/_lzf_cy.pyx":41
 *     cdef unsigned int ret
 *     with nogil:
 *         ret = lzf_compress(<void *> &data[0], <unsigned int> data.shape[0],             # <<<<<<<<<<<<<<
 *                                             <void *> &out[0], <unsigned int> out.shape[0])
 ...
 */
        ...
        /* "pylzf/backends/cython/_lzf_cy.pyx":42
 *     with nogil:
 *         ret = lzf_compress(<void *> &data[0], <unsigned int> data.shape[0],
 *                                             <void *> &out[0], <unsigned int> out.shape[0])             # <<<<<<<<<<<<<<
 *     if ret == 0:
 ...
 *     if ret == 0:
 */
        __pyx_v_ret = lzf_compress(((void *)(&(*((uint8_t const  *) ( /* dim=0 */ ((char *) (((uint8_t const  *) __pyx_v_data.data) + __pyx_t_1)) ))))), ((unsigned int)(__pyx_v_data.shape[0])), ((void *)(&(*((uint8_t *) ( /* dim=0 */ ((char *) (((uint8_t *) __pyx_v_out.data) + __pyx_t_2)) ))))), ((unsigned int)(__pyx_v_out.shape[0])));
      }
 ...
 */
  ...
  /* "pylzf/backends/cython/_lzf_cy.pyx":43
 *         ret = lzf_compress(<void *> &data[0], <unsigned int> data.shape[0],
 *                                             <void *> &out[0], <unsigned int> out.shape[0])
 *     if ret == 0:             # <<<<<<<<<<<<<<
 *         raise ValueError
 ...
 */
  ...
  if (unlikely(__pyx_t_3)) {
    ...
    /* "pylzf/backends/cython/_lzf_cy.pyx":44
 *                                             <void *> &out[0], <unsigned int> out.shape[0])
 *     if ret == 0:
 *         raise ValueError             # <<<<<<<<<<<<<<
 *     return ret
 ...
 */
  ...
  /* "pylzf/backends/cython/_lzf_cy.pyx":45
 *     if ret == 0:
 *         raise ValueError
 *     return ret             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_AddTraceback("pylzf.backends.cython._lzf_cy.compress_into", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_5pylzf_8backends_6cython_7_lzf_cy_5compress_into(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_5pylzf_8backends_6cython_7_lzf_cy_4compress_into[] = "compress_into(const uint8_t[::1] data, uint8_t[::1] out) -> unsigned int";
static PyObject *__pyx_pw_5pylzf_8backends_6cython_7_lzf_cy_5compress_into(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_data = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  __Pyx_RefNannySetupContext("compress_into (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_out)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("compress_into", 1, 2, 2, 1); __PYX_ERR(0, 38, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "compress_into") < 0)) __PYX_ERR(0, 38, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 2) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_data = __Pyx_PyObject_to_MemoryviewSlice_dc_nn_uint8_t__const__(values[0], 0); if (unlikely(!__pyx_v_data.memview)) __PYX_ERR(0, 38, __pyx_L3_error)
    __pyx_v_out = __Pyx_PyObject_to_MemoryviewSlice_dc_nn_uint8_t(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_out.memview)) __PYX_ERR(0, 38, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("compress_into", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 38, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("pylzf.backends.cython._lzf_cy.compress_into", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_5pylzf_8backends_6cython_7_lzf_cy_4compress_into(__pyx_self, __pyx_v_data, __pyx_v_out);
...
static PyObject *__pyx_pf_5pylzf_8backends_6cython_7_lzf_cy_4compress_into(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_out) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  __Pyx_RefNannySetupContext("compress_into", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_data.memview)) { __Pyx_RaiseUnboundLocalError("data"); __PYX_ERR(0, 38, __pyx_L1_error) }
  if (unlikely(!__pyx_v_out.memview)) { __Pyx_RaiseUnboundLocalError("out"); __PYX_ERR(0, 38, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_5pylzf_8backends_6cython_7_lzf_cy_compress_into(__pyx_v_data, __pyx_v_out, 0); if (unlikely(__pyx_t_1 == ((unsigned int)0))) __PYX_ERR(0, 38, __pyx_L1_error)
  __pyx_t_2 = __Pyx_PyInt_From_unsigned_int(__pyx_t_1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 38, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_r = __pyx_t_2;
  __pyx_t_2 = 0;
  goto __pyx_L0;
...
/* "pylzf/backends/cython/_lzf_cy.pyx":47
 *     return ret
 * 
 * cpdef inline unsigned int decompress_into(const uint8_t[::1] data, uint8_t[::1] out) except 0:             # <<<<<<<<<<<<<<
 *     cdef unsigned int ret
...
static PyObject *__pyx_pw_5pylzf_8backends_6cython_7_lzf_cy_7decompress_into(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static CYTHON_INLINE unsigned int __pyx_f_5pylzf_8backends_6cython_7_lzf_cy_decompress_into(__Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_out, CYTHON_UNUSED int __pyx_skip_dispatch) {
  unsigned int __pyx_v_ret;
  unsigned int __pyx_r;
  __Pyx_RefNannyDeclarations
  Py_ssize_t __pyx_t_1;
  ...
  /* "pylzf/backends/cython/_lzf_cy.pyx":49
 * cpdef inline unsigned int decompress_into(const uint8_t[::1] data, uint8_t[::1] out) except 0:
 *     cdef unsigned int ret
 *     with nogil:             # <<<<<<<<<<<<<<
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        /* "pylzf/backends/cython/_lzf_cy.pyx":50
 *     cdef unsigned int ret
 *     with nogil:
 *         ret = lzf_decompress(<void *> &data[0], <unsigned int> data.shape[0],             # <<<<<<<<<<<<<<
 *                                             <void *> &out[0], <unsigned int> out.shape[0])
 ...
 */
        ...
        /* "pylzf/backends/cython/_lzf_cy.pyx":51
 *     with nogil:
 *         ret = lzf_decompress(<void *> &data[0], <unsigned int> data.shape[0],
 *                                             <void *> &out[0], <unsigned int> out.shape[0])             # <<<<<<<<<<<<<<
 *     if ret == 0:
 ...
 *     if ret == 0:
 */
        __pyx_v_ret = lzf_decompress(((void *)(&(*((uint8_t const  *) ( /* dim=0 */ ((char *) (((uint8_t const  *) __pyx_v_data.data) + __pyx_t_1)) ))))), ((unsigned int)(__pyx_v_data.shape[0])), ((void *)(&(*((uint8_t *) ( /* dim=0 */ ((char *) (((uint8_t *) __pyx_v_out.data) + __pyx_t_2)) ))))), ((unsigned int)(__pyx_v_out.shape[0])));
      }
 ...
 */
  ...
  /* "pylzf/backends/cython/_lzf_cy.pyx":52
 *         ret = lzf_decompress(<void *> &data[0], <unsigned int> data.shape[0],
 *                                             <void *> &out[0], <unsigned int> out.shape[0])
 *     if ret == 0:             # <<<<<<<<<<<<<<
 *         raise ValueError
 ...
 */
  ...
  if (unlikely(__pyx_t_3)) {
    ...
    /* "pylzf/backends/cython/_lzf_cy.pyx":53
 *                                             <void *> &out[0], <unsigned int> out.shape[0])
 *     if ret == 0:
 *         raise ValueError             # <<<<<<<<<<<<<<
 *     return ret
 ...
 */
  ...
  /* "pylzf/backends/cython/_lzf_cy.pyx":54
 *     if ret == 0:
 *         raise ValueError
 *     return ret             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_AddTraceback("pylzf.backends.cython._lzf_cy.decompress_into", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_5pylzf_8backends_6cython_7_lzf_cy_7decompress_into(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_5pylzf_8backends_6cython_7_lzf_cy_6decompress_into[] = "decompress_into(const uint8_t[::1] data, uint8_t[::1] out) -> unsigned int";
static PyObject *__pyx_pw_5pylzf_8backends_6cython_7_lzf_cy_7decompress_into(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_data = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_out = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  ...
  __Pyx_RefNannySetupContext("decompress_into (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_out)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("decompress_into", 1, 2, 2, 1); __PYX_ERR(0, 47, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "decompress_into") < 0)) __PYX_ERR(0, 47, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 2) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_data = __Pyx_PyObject_to_MemoryviewSlice_dc_nn_uint8_t__const__(values[0], 0); if (unlikely(!__pyx_v_data.memview)) __PYX_ERR(0, 47, __pyx_L3_error)
    __pyx_v_out = __Pyx_PyObject_to_MemoryviewSlice_dc_nn_uint8_t(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_out.memview)) __PYX_ERR(0, 47, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("decompress_into", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 47, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("pylzf.backends.cython._lzf_cy.decompress_into", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_5pylzf_8backends_6cython_7_lzf_cy_6decompress_into(__pyx_self, __pyx_v_data, __pyx_v_out);
...
static PyObject *__pyx_pf_5pylzf_8backends_6cython_7_lzf_cy_6decompress_into(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_out) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  unsigned int __pyx_t_1;
  PyObject *__pyx_t_2 = NULL;
  ...
  if (unlikely(!__pyx_v_out.memview)) { __Pyx_RaiseUnboundLocalError("out"); __PYX_ERR(0, 47, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_5pylzf_8backends_6cython_7_lzf_cy_decompress_into(__pyx_v_data, __pyx_v_out, 0); if (unlikely(__pyx_t_1 == ((unsigned int)0))) __PYX_ERR(0, 47, __pyx_L1_error)
  __pyx_t_2 = __Pyx_PyInt_From_unsigned_int(__pyx_t_1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 47, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_r = __pyx_t_2;
  __pyx_t_2 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "pylzf.backends.cython._lzf_cy.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "pylzf.backends.cython._lzf_cy.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "pylzf.backends.cython._lzf_cy.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "pylzf.backends.cython._lzf_cy._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"compress", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_5pylzf_8backends_6cython_7_lzf_cy_1compress, METH_VARARGS|METH_KEYWORDS, __pyx_doc_5pylzf_8backends_6cython_7_lzf_cy_compress},
  {"decompress", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_5pylzf_8backends_6cython_7_lzf_cy_3decompress, METH_VARARGS|METH_KEYWORDS, __pyx_doc_5pylzf_8backends_6cython_7_lzf_cy_2decompress},
  {"compress_into", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_5pylzf_8backends_6cython_7_lzf_cy_5compress_into, METH_VARARGS|METH_KEYWORDS, __pyx_doc_5pylzf_8backends_6cython_7_lzf_cy_4compress_into},
  {"decompress_into", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_5pylzf_8backends_6cython_7_lzf_cy_7decompress_into, METH_VARARGS|METH_KEYWORDS, __pyx_doc_5pylzf_8backends_6cython_7_lzf_cy_6decompress_into},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec__lzf_cy(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec__lzf_cy},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_LZF_VERSION, __pyx_k_LZF_VERSION, sizeof(__pyx_k_LZF_VERSION), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC init_lzf_cy(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC init_lzf_cy(void)
#else
__Pyx_PyMODINIT_FUNC PyInit__lzf_cy(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit__lzf_cy(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec__lzf_cy(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module '_lzf_cy' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit__lzf_cy(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("_lzf_cy", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_pylzf__backends__cython___lzf_cy) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pylzf.backends.cython._lzf_cy")) {
      if (unlikely(PyDict_SetItemString(modules, "pylzf.backends.cython._lzf_cy", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "pylzf/backends/cython/_lzf_cy.pyx":56
 *     return ret
 * 
 * LZF_VERSION = LZF_VERSION_C             # <<<<<<<<<<<<<<
 */
  __pyx_t_1 = __Pyx_PyInt_From_int(LZF_VERSION); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 56, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_LZF_VERSION, __pyx_t_1) < 0) __PYX_ERR(0, 56, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "pylzf/backends/cython/_lzf_cy.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pylzf.backends.cython._lzf_cy", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pylzf.backends.cython._lzf_cy");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
